...
<head>
  ...
  <title>
    CataloguePlus - Gestion des utilisateurs
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouterusers.php">Ajouter un utilisateur</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-primary"><a href="modifierusers.php?updateid='.$id.'" class="text-light">Modifier</a></button>
                    <button class="btn btn-danger"><a href="deleteusers.php?deleteid='.$id.'" class="text-light">Supprimer</a></button>
                    </td>
                    </tr>';
                    }
                    }
