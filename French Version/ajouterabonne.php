...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO abonné (genre,nom,prenom,adresse,tel,naissance) values('$genre','$nom', '$prenom', '$adresse', '$tel', '$naissance')";
...
<head>
  ...
  <title>
    CataloguePlus - Ajout d'un abonné
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Ajout d'un abonné</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-3 pl-md-1">
                     ...
                     <div class="col-md-3 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="naissance" autocomplete="off">
                      </div>
                    </div>
                  </div>
                  <div class="row">
