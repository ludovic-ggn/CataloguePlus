<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO actu (titre,du,au,message) values('$titre','$du', '$au', '$message')";
...
<head>
  ...
  <title>
    CataloguePlus - Ajout d'une Actualité
  </title>
  <!--     Fonts and icons     -->
                ...
                <form method="post">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Du</label>
                        <input type="date" class="form-control" name="du" autocomplete="off">
                      </div>
                    </div>
                      <div class="col-md-6">
                      <div class="form-group">
                        <label>Au</label>
                        <input type="date" class="form-control" name="au" autocomplete="off">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Contenu</label>
                         <textarea rows="6" cols="80" class="form-control" name="message" autocomplete="off"></textarea>
                      </div>
                    </div>
                    </div>
                  <div>
                <button type="submit" class="btn btn-fill btn-primary" name="submit">Ajouter</button>
                 </div>
                </form>
              </div>
            </div>
