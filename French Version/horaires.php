...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="horaires.php" class="nav-item nav-link active">Horaires</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Horaires</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Horaires Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Les Horaires</span></h2>
        <div class="row px-xl-5">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <?php echo $infolundimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infolundimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infomardimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infomardimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infomercredimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infomercredimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infojeudimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infojeudimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infovendredimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infovendredimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infosamedimatin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infosamedimidi ?>
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td class="text-center">
                          <?php echo $infodimanchematin ?>
                        </td>
                        <td class="text-center">
                          <?php echo $infodimanchemidi ?>
                        </td>
                      </tr>
                    </tbody>
                  </table>
