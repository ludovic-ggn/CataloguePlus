...
<body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="lesactus.php" class="nav-item nav-link active">Les Actus</a>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Les Actus</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <!-- Actus Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Les Actus</span></h2>
        <div class="row px-xl-5">
   ...
   $au=$row['au'];
                    echo '<tr>
                            <td class="align-middle"><a href="actuview.php?actuid='.$id.'" class="text-light"><h5>'.$titre.'</h5></a></td>
                            <td class="align-middle"><h5>'.$du.'</h5></td>
                            <td class="align-middle"><h5>'.$au.'</h5></td>
                        </tr>';
                    }
                    }
                    ?>  
