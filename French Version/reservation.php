...
<head>
  ...
  <title>
    CataloguePlus - Gestion des Reservations
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouterreservation.php">Ajouter une Reservation</a>
              </div>
              <div class="card-body">
                  ...
                  <table class="table tablesorter " id="">
                    <thead class=" text-primary">
                      <tr>
                        ...
                        <th scope="col">Fin de la reservation le</th>
                    ...
                    <td>'.$reservecard.'</td>
                    <td>'.$retour.'</td>
                    <td>'.$finreservation.'</td>
                    <td>'.$status.'</td>
                    <td class="text-center">
                    <button class="btn btn-danger"><a href="annulerreservation.php?annulation='.$id.'" class="text-light">Annuler</a></button>
                    </td>
                    </tr>';
                    }
                    }
