...
$reservecard= mysqli_real_escape_string($conn, $_POST['reservecard']);	
$sql="update books set id=$id,reserve='Oui',reservecard='$reservecard',reservele='$date' where id=$id";
...
<head>
  ...
  <title>
    CataloguePlus - Ajout d'une reservation
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Ajout d'une Reseration</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    ...
                    <div class="col-md-6 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="reservecard" autocomplete="off" required>
                      </div>
                    </div>
                  </div>
                  <div>
                <button type="submit" class="btn btn-fill btn-primary" name="submit">Réserver</button>
                 </div>
                </form>
              </div>
            </div>
