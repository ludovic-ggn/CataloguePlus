            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="bg-light p-4 mb-30">
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=roman" style="text-decoration: none; color: #6c757d;">Roman</a>
                  ...
                  ?></span>
                            ...
                            <a href="catalogue.php?terme=jeunesse" style="text-decoration: none; color: #6c757d;">Jeunesse</a>
                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature,public) LIKE '%jeunesse%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
                  ?></span>
                            ...
                            <a href="catalogue.php?terme=fantastique" style="text-decoration: none; color: #6c757d;">Fantastique</a>
                            <span class="badge border font-weight-normal"><?php
                  ...
                  ?></span>
                    ...
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=Aventure" style="text-decoration: none; color: #6c757d;">Aventure</a>
                            <span class="badge border font-weight-normal"><?php
                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=tous" style="text-decoration: none; color: #6c757d;">Tous</a>

                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(public) LIKE '%tous%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
                  ?></span>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=jeunesse" style="text-decoration: none; color: #6c757d;">Jeunesse</a>
                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(public) LIKE '%jeunesse%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
