...
<?php
  ...
  if(isset($_POST['submitretour'])){
    ...
    $reserve=$row['reserve'];
    if ($reserve == 'Oui'){
      echo '<script>alert("ATTENTION CE DOCUMENT EST RESERVE");</script>';
    }   
    $date = date('Y-m-d');
    $finreservation =  date('Y-m-d', strtotime($date. ' + 5 days'));
    $sql="update books set id=$id,status='Oui',nom='',retour='',demprunt='',finreservation='$finreservation' where id=$id";
    $result=mysqli_query($conn,$sql);
    if ($result) {
      ...
      <div class="content">
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h2 class="card-title">Emprunt Rapide</h2>
                  </div>
                </div>
              </div>
              <div class="card-body">
                ...
                <button type="submit" class="btn btn-fill btn-primary" name="submitpret">Prêter</button>
                 </div>
                </form>
              </div>
            </div>
          ...
          <div class="col-6">
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    <h2 class="card-title">Retour Rapide</h2>
                  </div>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <div class="col-md-5 px-md-2">
                <button type="submit" class="btn btn-fill btn-primary" name="submitretour">Retourner</button>
                 </div>
                </form>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card card-chart">
              <div class="card-header">
                <h3 class="card-title"><i class="tim-icons icon-badge text-success"></i> Abonnés</h3>
              </div>
              <div class="card-body">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h3 class="card-title"><i class="tim-icons icon-bullet-list-67 text-success"></i> Emprunt en cours</h3>
              </div>
              <div class="card-body">
                <h1 style="text-align: center;">
                  <?php
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h3 class="card-title"><i class="tim-icons icon-simple-remove text-danger"></i> Retard en cours</h3>
              </div>
              <div class="card-body">
                <h1 style="text-align: center;">
                  <?php
