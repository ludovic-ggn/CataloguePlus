<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO suggestion (titre,auteur) values('$titre','$auteur')";
...
<head>
  ...
  <title>
    CataloguePlus - Ajout d'une suggestion d'achat
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Ajout d'une suggestion d'achat</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Titre</label>
                        <input type="text" class="form-control" name="titre" autocomplete="off" required>
                      </div>
                    </div>
