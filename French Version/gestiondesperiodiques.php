...
<head>
  ...
  <title>
    CataloguePlus - Gestion des Periodiques
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Liste des periodiques</h4>
                <a href="ajouterperiodique.php">Ajouter un periodique</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-info"><a href="ajouternumero.php?periodiqueid='.$id.'" class="text-light">Ajouter Numero</a></button>
                    <button class="btn btn-primary"><a href="modifierabonnement.php?updateid='.$id.'" class="text-light">Modifier</a></button>
                    <button class="btn btn-danger"><a href="deleteabonnement.php?deleteid='.$id.'" class="text-light">Supprimer</a></button>
                    </td>
                    </tr>';
                    }
                    }
