...
<head>
  ...
  <title>
    CataloguePlus - Suggestions d'achat
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Suggestions d'achat</h4>
                <a href="ajoutersuggestion.php">Ajouter une suggestion</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-danger"><a href="deletesuggestion.php?deleteid='.$id.'" class="text-light">Supprimer</a></button>
                    </td>
                    </tr>';
                    }
                    }
