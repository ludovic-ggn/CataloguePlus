<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO books (support,langue,titre,auteur,parution,cb,isbn,cout,editeurs,collection,collation,cote,type,nature,genres,public,resume,status,retour,nom,demprunt,reserve,reservecard,finreservation,reservele) values('$support','$langue', '$titre', '', '$parution','', '$isbn', '', '$editeurs', '', '', '', 'Periodique', '', '', '$public', '$resume', 'Oui', '','','','','','','')";
    $result=mysqli_query($conn,$sql);
    if ($result) {
...
<head>
  ...
  <title>
    CataloguePlus - Ajout d'un numéro periodique
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Ajout d'un numéro periodique</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
