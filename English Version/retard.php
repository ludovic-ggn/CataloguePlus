...
<head>
  ...
  <title>
    CataloguePlus - Overdue Management
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">List of Overdue</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table tablesorter " id="">
                    <thead class=" text-primary">
                      <tr>
                        ...
                        <th scope="col">Return scheduled for</th>
                    ...
                    <button class="btn btn-info"><a href="retardedit.php?viewid='.$id.'" class="text-light">View</a></button>
                    </td>
                    </tr>';
                    }
                    }
