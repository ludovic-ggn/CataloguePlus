...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=novel">
                  ...
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%novel%'";
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=journal">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Journal</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%journal%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=youth">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Youth</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%youth%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=comic">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Comic</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%Comic%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=Biography">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Biography</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%Biography%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=Adventure">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/aventure.png" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Adventure Novel</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%Adventure%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=theater">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Theater</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%theater%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=Fantastic">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Fantastic</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%fantastic%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=poetry">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Poetry</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%poetry%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="catalogue.php?terme=tale">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                        ...
                        <div class="flex-fill pl-3">
                            <h6>Tale, Legend</h6>
                            <small class="text-body"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature) LIKE '%tale%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
    ...
    <div id="lesnouveautés" class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">The News</span></h2>
        <div class="row px-xl-5">
        <?php
