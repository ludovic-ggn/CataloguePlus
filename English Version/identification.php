...
if (isset($_POST['submit'])){
  ...
  if($rows==1){
    ...
    $message = "The card number or date of birth is incorrect.";
  }
}
?>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-12">
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="row">
                        <button style="margin-left: auto; margin-right: auto;" type="submit" name="submit" class="btn btn-primary">Login</button>
                    </div>
                    <div class="row">
