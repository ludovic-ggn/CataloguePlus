...
<head>
  ...
  <title>
    CataloguePlus - Changing a recurring subscriprion
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Biobliographic Description</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Journal ..." name="support" autocomplete="off" value="<?= htmlspecialchars($support) ?>">
                      </div>
                    </div>
