...
<head>
  ...
  <title>
    CataloguePlus - Adding a periodical
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Biobliographic Management</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                    <div class="col-md-5 pr-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Journal ..." name="support" autocomplete="off">
                      </div>
                    </div>
                    <div class="col-md-5 px-md-2">
                      <div class="form-group">
                        <label>Languages</label>
                        <input type="text" class="form-control" placeholder="English, French ..." name="langue" autocomplete="off">
                      </div>
                    </div>
                  </div>
                  <div class="row">
