...
<head>
  ...
  <title>
    CataloguePlus - Periodical Management
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">List of periodicals</h4>
                <a href="ajouterperiodique.php">Add a periodical</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-info"><a href="ajouternumero.php?periodiqueid='.$id.'" class="text-light">Add Number</a></button>
                    <button class="btn btn-primary"><a href="modifierabonnement.php?updateid='.$id.'" class="text-light">Edit</a></button>
                    <button class="btn btn-danger"><a href="deleteabonnement.php?deleteid='.$id.'" class="text-light">Delete</a></button>
                    </td>
                    </tr>';
                    }
                    }
