...
<head>
  ...
  <title>
    CataloguePlus - Purchase Suggestions
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                <h4 class="card-title">Purchase Suggestions</h4>
                <a href="ajoutersuggestion.php">Add a suggestion</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-danger"><a href="deletesuggestion.php?deleteid='.$id.'" class="text-light">Delete</a></button>
                    </td>
                    </tr>';
                    }
                    }
