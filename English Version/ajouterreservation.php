...
$sql="update books set id=$id,reserve='Yes',reservecard='$reservecard',reservele='$date' where id=$id";
...
<head>
  ...
  <title>
    CataloguePlus - Add a reservation
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add a reservation</h5>
              </div>
              <div class="card-body">
                <form method="post">
                  <div class="row">
                  ...
                  <div>
                <button type="submit" class="btn btn-fill btn-primary" name="submit">Reserve</button>
                 </div>
                </form>
              </div>
            </div>
