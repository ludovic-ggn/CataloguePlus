...
<head>
  ...
  <title>
    CataloguePlus - Catalog Management
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouterdocument.php">Add document</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-info"><a href="ajouterexemplaire.php?exemplaireid='.$id.'" class="text-light">Add Copy</a></button>
                    <button class="btn btn-primary"><a href="modifierdocument.php?updateid='.$id.'" class="text-light">Edit</a></button>
                    <button class="btn btn-danger"><a href="deletedocument.php?deleteid='.$id.'" class="text-light">DELETE</a></button>
                    </td>
                    </tr>';
                    }
                    }
