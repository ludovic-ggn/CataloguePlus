...
<head>
  ...
  <title>
    CataloguePlus - Editing a Overdue
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Overdue - <?php echo $titre; ?></h5>
              </div>
              <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Name of current borrower:</label>
                        <h5> <?php echo $nom ?> </h5>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <?php
                        echo'
                         <button class="btn btn-info"><a href="retardlettre.php?viewid='.$id.'" class="text-light">Late Mail</a></button>'
                         ?>
                        </br>
                       </br>
                       </br>
