                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="catalogue.php" class="nav-item nav-link active">Catalog</a>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-3 col-md-4">
                <!-- Price Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Genres</span></h5>
                <div class="bg-light p-4 mb-30">
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=novel" style="text-decoration: none; color: #6c757d;">Novel</a>
                  ...
                  ?></span>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=fiction" style="text-decoration: none; color: #6c757d;">Fiction</a>
                            <span class="badge border font-weight-normal"><?php
                  ...
                  ?></span>
                            ...
                            <a href="catalogue.php?terme=Youth" style="text-decoration: none; color: #6c757d;">Youth</a>
                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(genres,nature,public) LIKE '%youth%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
                  ?></span>
                            ...
                            <a href="catalogue.php?terme=fantastic" style="text-decoration: none; color: #6c757d;">Fantastic</a>
                            <span class="badge border font-weight-normal"><?php
                  ...
                  ?></span>
                    ...
                    <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=Adventure" style="text-decoration: none; color: #6c757d;">Adventure</a>
                            <span class="badge border font-weight-normal"><?php
                ...
                <!-- Size Start -->
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Public</span></h5>
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=all" style="text-decoration: none; color: #6c757d;">All</a>

                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(public) LIKE '%all%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
                  ?></span>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <a href="catalogue.php?terme=youth" style="text-decoration: none; color: #6c757d;">Youth</a>
                            <span class="badge border font-weight-normal"><?php
                  $sql = "SELECT * from books WHERE CONCAT(public) LIKE '%youth%'";
                  if ($result = mysqli_query($conn, $sql)) {
                  $rowcount = mysqli_num_rows( $result );
                  echo $rowcount;
                  }
            ...
            <div class="col-lg-9 col-md-8">
                <div class="row pb-3">
                    ...
                    $sql="SELECT * from books WHERE CONCAT(titre,resume,auteur,nature,genres,public) LIKE '%$terme%'";
                    $result=mysqli_query($conn,$sql);
                    if ($result) {
                    while ($row=mysqli_fetch_assoc($result)){
                    $id=$row['id'];
