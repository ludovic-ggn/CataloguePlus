...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <a class="breadcrumb-item text-dark" href="catalogue.php">Catalog</a>
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4">Publication date: <?php echo $parution ?></p>
                    <p class="mb-4">Audience: <?php echo $public ?></p>
                    <p class="mb-4">Kind: <?php echo $nature ?></p>
                    <p class="mb-4">Type: <?php echo $genres ?></p>
                    <h6 class="font-weight-semi-bold mb-4">Available: <?php echo $status ?></h6>
                    <div class="d-flex align-items-center mb-4 pt-2">
                    <form action="jereserve.php" method="get">
                     <button name="reservation" value="<?php echo $id ?>" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Reserve</button>
                    </form>   
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item px-0">
                                            Publication date: <?php echo $parution ?>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Kind: <?php echo $nature ?>
                                        </li>
                                      </ul> 
                                </div>
                                <div class="col-md-6">
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item px-0">
                                            Editor: <?php echo $editeurs ?>
                                        </li>
                                        <li class="list-group-item px-0">
                                            ISBN: <?php echo $isbn ?>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Number of pages: <?php echo $collation ?>
                                        </li>
                                        <li class="list-group-item px-0">
                                            Type: <?php echo $genres ?>
                                        </li>
                                      </ul> 
                                </div>
                            </div>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Suggestions related to <?php echo $titre ?></span></h2>
        <div class="row px-xl-5">
