...
<head>
  ...
  <title>
    CataloguePlus - Subscriber Management
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouterabonne.php">Add a subscriber</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-primary"><a href="modifierabonné.php?updateid='.$id.'" class="text-light">Edit</a></button>
                    <button class="btn btn-danger"><a href="deleteabonnés.php?deleteid='.$id.'" class="text-light">Delete</a></button>
                    </td>
                    </tr>';
                    }
                    }
