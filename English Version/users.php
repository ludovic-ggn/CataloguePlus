          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouterusers.php">Add user</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <button class="btn btn-primary"><a href="modifierusers.php?updateid='.$id.'" class="text-light">Edit</a></button>
