...
<head>
  ...
  <title>
    CataloguePlus - Portal Management
  </title>
  <!--     Fonts and icons     -->
          ...
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <button class="btn btn-fill btn-primary" type="submit" name="submit">Edit</button>
              </div>
              </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header">
                ...
                <a href="ajouteractu.php">Add news</a>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <td>'.$au.'</td>
                    <td class="text-center">
                    <button class="btn btn-primary"><a href="modifieractu.php?actuid='.$id.'" class="text-light">Edit</a></button>
                    <button class="btn btn-danger"><a href="deleteactu.php?actuid='.$id.'" class="text-light">Delete</a></button>
                    </td>
                    </tr>';
                    }
                    }
